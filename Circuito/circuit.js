...
const RIGHT_TERMINAL_ON_ANGLE = -10; // Angolo "chiuso" per il terminale destro
...
const LEFT_TERMINAL_OFF_ANGLE = -34; // Angolo "aperto" per il terminale sinistro (originale)
const LEFT_TERMINAL_ON_ANGLE = -15; // Angolo "chiuso" per il terminale sinistro (da calibrare per toccare)
...
function mousePressed() {
  ...
  const clickableRightTerminalX = 300;
  const clickableRightTerminalY = 0;
  const clickableRightTerminalWidth = 70;
  const clickableRightTerminalHeight = 30;

  // Area cliccabile per il terminale SINISTRO
  const clickableLeftTerminalX = 100;
  const clickableLeftTerminalY = 0;
  const clickableLeftTerminalWidth = 70;
  const clickableLeftTerminalHeight = 30;
